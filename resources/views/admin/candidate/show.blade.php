                            ...
                            <div class="candidate-details__right">
                                ...
                                <div class="four">
                                    ...
                                    <div class="mb-4 d-flex">
                                        ...
                                        <div>
                                            <p>{{ __('phone') }}/Whatsapp</p>
                                            <a href="https://api.whatsapp.com/send?phone=62{{ $user->contactInfo->phone }}&text=Halooo... {{ $candidate->user->name }}%0AKami%20dari%20DisNaker%20TapSel%20%0A">{{ $user->contactInfo->phone }}</a>
