...
class KabupatenController extends Controller
{
    ...
    public function index()
    {
        ...
        $kabupatenCategories = Kabupaten::with('negara')->get();
        ...
        return view('admin.Kabupaten.index', compact('kabupatenCategories', 'negaraCategories', 'app_language', 'select2Options'));
    }
