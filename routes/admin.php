...
use App\Http\Controllers\Admin\StatusPelamarController;
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::get('/company/available/status', [CompanyController::class, 'availableChange'])->name('company.available.change');
        Route::get('/download-report-company', [CompanyController::class, 'downloadReportCompany'])->name('download_report_company');
        Route::get('/download-company-candidate', [CompanyController::class, 'downloadCompanyCandidate'])->name('download_company_candidate');
        ...
        Route::get('/download-report-candidate', [CandidateController::class, 'downloadReportCandidate'])->name('download_report_candidate');

        // ============ Candidate ===========
        Route::resource('status_pelamar', StatusPelamarController::class);
        Route::post('/status_pelamar/get/city', [StatusPelamarController::class, 'city'])->name('status_pelamar.city');
        Route::post('/status_pelamar/get/state', [StatusPelamarController::class, 'state'])->name('status_pelamar.state');
        Route::get('/status_pelamar/change/status', [StatusPelamarController::class, 'statusChange'])->name('status_pelamar.status.change');
        Route::get('/download-report-status_pelamar', [StatusPelamarController::class, 'downloadReportStatusPelamar'])->name('download_report_status_pelamar');
        ...
        Route::get('/download-report-job', [JobController::class, 'downloadReportJob'])->name('download_report_job');
