...
@section('website-settings')
    <div class="container-fluid">
        <div class="alert alert-warning mb-3">
            <h5>
                For exchange rates, we use. according to the free API from
                <a href="https://exchangerate.host" target="_blank" class="text-primary">
                    Exchangerate.host
                </a>
            </h5>
            <hr class="my-2">
        ...
        <form class="row" action="{{ route('module.currency.default') }}" method="POST">
            ...
            <div class="col-md-3 mb-4">
                <div class="">
                    <x-forms.label name="set Default Currency" class="" for="inlineFormCustomSelect" />
